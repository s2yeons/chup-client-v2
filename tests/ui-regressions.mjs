...
const applicationsView = await readSource('../apps/client/src/views/applications/ui/ApplicationsView.tsx');
...
const adminNavigation = await readSource('../apps/admin/src/widgets/app-navigation/ui/AppNavigation.tsx');
